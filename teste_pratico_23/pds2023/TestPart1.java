public class TestPart1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            // System.out.println("studentadm: " + sAdm1);

            Director dir = new Director(sAdm1, Course.LEI);
            // System.out.println("diretor: " + dir.getCourseName());
            ...
            // System.out.println("professor1: " + prof1.getName() + " " + prof1.getClassName());
            // System.out.println("professor2: " + prof2.getName() + " " + prof2.getClassName());
            // System.out.println("professor3: " + prof3.getName() + " " + prof3.getClassName());

            sAdm1.addScore("Programming", 17.0);
            sAdm1.addScore("BD",  16.0);
            sAdm1.addScore("PDS", 15.0);
            // System.out.println("studentscore: " + st1.getScore2());
